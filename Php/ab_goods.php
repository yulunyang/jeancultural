...
$t_sql = "SELECT COUNT(1) FROM goods";
$total_rows = $pdo->query($t_sql)->fetch()[0];
$page_num = ceil($total_rows / $per_page) ;


$sql = sprintf("SELECT * FROM goods ORDER BY sid DESC LIMIT %s, %s",
...
<button type="button" class="btn btn-dark mb-3"><a href="ab_add_goods.php">新增</a></button>
...
<!-- <li class="page-item"><a class="page-link" href="#">Next</a></li> -->
    ...
    <table class="table table-striped table-bordered">
        ...
        <th scope="col">del</th>
            ...
            <th scope="col">尺寸</th>
            <th scope="col">價格</th>
            <th scope="col">主要圖片</th>
            <th scope="col">次要圖片</th>
            <th scope="col">庫存</th>
            <th scope="col">品項</th>
            <th scope="col">品牌</th>
            <th scope="col">類別</th>
...
<script>
        function del_it(sid){
            if(confirm('你確定要刪除編號為 '+sid+' 的資料嗎?')){
                location.href = 'ab_del_goods.php?sid=' + sid;
            }
        }
