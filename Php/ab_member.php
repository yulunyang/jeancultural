...
$sql = sprintf("SELECT * FROM members ORDER BY id ASC LIMIT %s, %s",
...
<!-- <li class="page-item"><a class="page-link" href="#">Next</a></li> -->
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td><a href="ab_edit_member.php?id=<?= $r['id'] ?>"><i class="fas fa-edit"></a></i></td>
        </tr>
        <?php endwhile; ?>
        </tbody>
    </table>
...
<script>
        function del_it(id){
            if(confirm('你確定要刪除編號為 '+id+' 的資料嗎?')){
                location.href = 'ab_del_members.php?sid=' + id;
            }
        }
