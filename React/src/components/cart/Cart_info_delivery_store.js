...
class Cart_info_delivery_store extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <div className={this.props.deliveryStoreState===true ? "K_step_show":"K_step_hidden"}>
